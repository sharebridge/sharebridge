...
**Doc map:** [README.md § Documentation guide](../README.md#documentation-map) (handover path: steps **10 → 13**) · Planned merge with seeker demand → [Configurator_Role_and_Unified_Initiation.md](../design/Configurator_Role_and_Unified_Initiation.md).
